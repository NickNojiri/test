...
public class PongTimer 
    ...
    public PongTimer(PongBall ball, 
                         PongCanvas canvas,
                         PongPaddle paddle1,
                         PongPaddle paddle2,
                         PongScore player1,
    ...
    public void run() {
        ...
        // Move the paddle into the timer thread
        // Poll the paddle twice as often as the
        // ball moves
        if (canvas.leftUp()) {
        ...
        if (canvas.leftDown()) {
            if (paddle1.getBottomY() < canvas.getHeight()-30) {
                paddle1.moveDown(2);
            }
        }
        if (canvas.rightUp()) {
        ...
        if (canvas.rightDown()) {
            if (paddle2.getBottomY() < canvas.getHeight()-30) {
                paddle2.moveDown(2);
            }
        }
