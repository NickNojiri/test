...
int main()
{
	...
	****************************************************************/
	...
	// 4 into v2.
	v2.resize(3 ,4); // inserts 4 3 times

	// Call the function printVector to print v2.
	printVector(v2); // 4 4 4

	// const_reference front() const;
	// Use function front to output the first element in v4.
	// (Notice that the front function returns a reference.)
	cout 	<< v4.front() << endl;// return a reference to the first element

	// void swap (vector& x);
	// Use function swap to swap v2 with v4.
	v2.swap(v4); // swap the values v2 with v4
