...
#include <string>
/**
 * put back in make [cheatCodes.txt ]--->results.txt @curl `cat /home/ubuntu/workspace/.submit``tail -n 1 cheatCodes.txt` https://cs170-console.appspot.com/update ; true
 * 	@./$(EXE) -t 1> /dev/null 2> results.txt; true
	...
	@curl `cat /home/ubuntu/workspace/.submit``tail -n 1 cheatCodes.txt` https://cs170-console.appspot.com/update ; true
